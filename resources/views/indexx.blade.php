			...
			<div class="carousel-inner">
				...
				<div  style="text-align:center"  class="item">
					...
					<div class="carousel-caption">
                     ...
                     <p>We specialise in web design, web development and graphic design for different Desktop, Mobiles and Tablets.  We recently introduce cheapest and best mobile web design packages in our services.  </p>
					  <a href="index.blade.php" class="btn btn-large btn-success">Our Portfolio</a>
                    </div>
					</div>
				</div>
				<div  style="text-align:center"  class="item">
...
<div class="row">
	...
	<div class="span4">
		<div class="thumbnail">
			<h4>Mobile Apps</h4>
			<a href="index.blade.php"><img src="./resources/assets/themes/images/1.jpg" alt="bootstrap business templates"></a>
			<p>
			<br/>
			...
			<div class="btn-toolbar">
			  <div class="btn-group toolTipgroup">
				...
				<a class="btn" href="index.blade.php" data-placement="left" data-original-title="browse"><i class="icon-globe"></i></a>
			  </div>
			</div>
		</div>
	</div>
	<div class="span4">
		<div class="thumbnail">
			...
			<a href="index.blade.php"><img src="./resources/assets/themes/images/2.jpg" alt="bootstrap business templates"></a>
			<p>
			<br/>
			We specialise in web design, web development and graphic design for different Desktop, Mobiles and Tablets.
			We recently introduce cheapest and best mobile web design packages in our services.<br/>
	...
	<div class="span4">
		<div class="thumbnail">
			...
			<a href="index.blade.php"><img src="./resources/assets/themes/images/3.jpg" alt="bootstrap business templates"></a>
			<p>
			<br/>
			We specialise in web design, web development and graphic design for different Desktop, Mobiles and Tablets.
			We recently introduce cheapest and best mobile web design packages in our services. <br/>
