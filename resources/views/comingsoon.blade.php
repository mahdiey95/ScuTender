...
<section id="bodySection"  style="text-align:center">
	<div class="container">
		<h6>Find us on</h6>
		<p>
			<a href="#facebook" role="button" data-toggle="modal"><img style="width:45px" src="./resources/assets/themes/images/facebook.png" alt="facebook" title="facebook"></a>
			<a href="#twitter" role="button" data-toggle="modal"><img style="width:45px" src="./resources/assets/themes/images/twitter.png"  alt="twitter" title="twitter"></a>
			<a href="#rss" role="button" data-toggle="modal"><img style="width:45px" src="./resources/assets/themes/images/rss.png"  alt="rss" title="rss"></a>
			<a href="#youtube" role="button" data-toggle="modal"><img style="width:45px" src="./resources/assets/themes/images/youtube.png"  alt="youtube" title="youtube"></a>
		</p>
		<br/>
