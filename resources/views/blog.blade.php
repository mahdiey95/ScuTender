...
<!--Header Ends================================================ -->
<!-- Page banner -->
<section id="bannerSection" style="background:url(./resources/assets/themes/images/banner/blog.png) no-repeat center center #000;">
	<div class="container" >	
...
<a href="blog_details.blade.php" style="display:block; background:url(./resources/assets/themes/images/blog/4.jpg) no-repeat center center; height:250px; max-height:250px; margin-bottom:18px"></a>
...
Our website prices below are complete - there are NO HIDDEN EXTRAS! [<a href="blog_details">More Details</a>]</p>
 ...
 <p>
	<a href="#" title="Comment on Cras in odio nisi">2 Comments</a> | 
...
<a href="blog_details.blade.php" style="display:block; background:url(./resources/assets/themes/images/blog/1.jpg) no-repeat center center; height:250px; max-height:250px; margin-bottom:18px"></a>
...
Our website prices below are complete - there are NO HIDDEN EXTRAS! [<a href="blog_details">More Details</a>]</p>
 ...
 <p>
	<a href="#" title="Comment on Cras in odio nisi">8 Comments</a> | 
	<a href="#">Add Comments</a> | 
	<a href="#">More Details</a>
</p>
</div>
...
<div id="myCarousel" class="carousel slide blogCarousel">
	<div class="carousel-inner">
		...
		<div  style="text-align:center"  class="item">
			<a href="blog_details.blade.php" style="display:block; background:url(./resources/assets/themes/images/blog/2.jpg) no-repeat center center; height:250px; max-height:250px; margin-bottom:18px"></a>
		</div>
		<div  style="text-align:center"  class="item">
			<a href="blog_details.blade.php" style="display:block; background:url(./resources/assets/themes/images/blog/3.jpg) no-repeat center center; height:250px; max-height:250px; margin-bottom:18px"></a>
		</div>
		<div  style="text-align:center"  class="item">
			<a href="blog_details.blade.php" style="display:block; background:url(./resources/assets/themes/images/blog/4.jpg) no-repeat center center; height:250px; max-height:250px; margin-bottom:18px"></a>
		</div>
		<div  style="text-align:center"  class="item">
			<a href="blog_details.blade.php" style="display:block; background:url(./resources/assets/themes/images/blog/5.jpg) no-repeat center center; height:250px; max-height:250px; margin-bottom:18px"></a>
		</div>
		<div  style="text-align:center"  class="item">
			<a href="blog_details.blade.php" style="display:block; background:url(./resources/assets/themes/images/blog/6.jpg) no-repeat center center; height:250px; max-height:250px; margin-bottom:18px"></a>
		</div>
	</div>
...
<br/>
<div class="thumbnail">
<h3><a href="#" title="my web solutions">which is best for you?</a></h3>
<p class="meta">Added by <a href="#" title="Posts by admin">admin</a> on <a href="#">November 14th, 2012</a>, filed under <a href="#" title="View all posts in Category 3">Category 3</a></p>
<iframe style="height:481px; width:100%; border:0" src="http://www.youtube.com/embed/tlfq6d8Lpuc" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
</p>
<p>
We specialise in web design, web development and graphic design for different Desktop, Mobiles and Tablets.

We recently introduce cheapest and best mobile web design packages in our services. This is most popular and beneficial for everyone. If you are looking for upgrade your website computable in mobiles and tablets, Even if you don’t have any website, then just remember us and makes your dream success. We are giving the best solution for your best value of money. [<a href="#">More Details</a>]
...
<div class="thumbnail">
	<a href="http://mywebsolution.info" target="_blank" ><img src="./resources/assets/themes/images/portfolio/mywebsolution.jpg" alt="bootstrap business templates"/></a>
